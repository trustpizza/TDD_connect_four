    ...
    context 'When the board is full' do
      before do
        board.instance_variable_set(:@grid, [
                                      [red_circle, yellow_circle, red_circle, yellow_circle, red_circle,
                                       yellow_circle, red_circle],
                                      [yellow_circle, red_circle, yellow_circle, red_circle, yellow_circle,
    ...
    context 'Horizontal Win Testing' do
      before do
        board.instance_variable_set(:@grid, [
                                      ...
                                      [empty_circle, empty_circle, empty_circle, empty_circle, empty_circle,
                                       empty_circle, empty_circle],
                                      [empty_circle, empty_circle, empty_circle, red_circle, red_circle,
